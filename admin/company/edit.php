          ...
          <!-- /.col-lg-12 -->
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      "COMPANYNAME">Program Name:</label>
                      ...
                      <div class="col-md-8">
                        ...
                        <input type="hidden" name="COMPANYID" value="<?php echo $res->COMPANYID ;?>">
                         <input class="form-control input-sm" id="COMPANYNAME" name="COMPANYNAME" placeholder=
                            "Program Name" type="text" value="<?php echo $res->COMPANYNAME ;?>">
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "COMPANYADDRESS">Program Description:</label> 
                      <div class="col-md-8">
                        <textarea class="form-control input-sm" id="COMPANYADDRESS" name="COMPANYADDRESS" placeholder=
                            "Program Description" type="text" value="" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off"><?php echo $res->COMPANYADDRESS ;?></textarea>
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      <label class="col-md-4 control-label" for=
                      "COMPANYCONTACTNO">Program Slot or Availability:</label>

                      <div class="col-md-8">
                         <input class="form-control input-sm" id="COMPANYCONTACTNO" name="COMPANYCONTACTNO" placeholder=
                            "Program Slot or Availability" type="text" value="<?php echo $res->COMPANYCONTACTNO ;?>">
                      </div>
                    </div>
                  </div>
