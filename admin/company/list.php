...
?>
	<div class="row">
       	 <div class="col-lg-12">
            <h1 class="page-header">List of Program  <a href="index.php?view=add" class="btn btn-primary btn-xs  ">  <i class="fa fa-plus-circle fw-fa"></i> Add Program</a>  </h1>
       		</div>
        	<!-- /.col-lg-12 -->
   		 </div>
				...
				<table id="dash-table" class="table table-striped table-bordered table-hover"  style="font-size:12px" cellspacing="0">
				  ...
				  <thead>
				  	<tr>
				  		...
				  		<th>Program Slot or Availability</th> 
