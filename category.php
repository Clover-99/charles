          ...
          <div class="panel panel-primary">
              <div class="panel-header">
                 <!--  <div style="border-bottom: 1px solid #ddd;padding: 10px;font-size: 20px;font-weight: bold;color: #000;margin-bottom: 5px;"><a href="<?php echo web_root.'index.php?q=viewjob&search='.$result->JOBID;?>"><?php echo $result->OCCUPATIONTITLE ;?></a> -->
                   <div style="border-bottom: 1px solid #ddd;padding: 10px;font-size: 20px;font-weight: bold;color: #000;margin-bottom: 5px;"><a href="<?php echo web_root.'index.php?q=viewjob&search='.$result->JOBID;?>"><?php echo $result->COMPANYNAME ;?></a> 
                    ...
                    <div class="col-sm-10">
                      ...
                      <!--  <div class="col-sm-6">
                       ...
                       <!-- <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                           <!-- <p>Program Name :  <?php echo  $result->COMPANYNAME ?></p>-->
